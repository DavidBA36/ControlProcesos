...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, FMX.TMSBaseControl, FMX.TMSBaseGroup, FMX.TMSCheckGroup, FMX.StdCtrls,
...
begin
  ...
  begin
    ...
    TMSFMXCheckGroup1.Items[i].Enabled := not aGrid.Columns.Items[i].Fixed;
    TMSFMXCheckGroup1.IsChecked[i] := True;
    TMSFMXCheckGroup1.Items[i].Text := Grid.Columns.Items[i].Name;
    if not aGrid.Columns.Items[i].Fixed then
